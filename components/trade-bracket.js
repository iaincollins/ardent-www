module.exports = ({ bracket }) => {
  if (bracket === 3) { // High
    ...
    return <> <i className='trade-bracket-icon text-warning flip-horizontal icarus-terminal-signal' /></>
  } else if (bracket === 0) { // None
    return <> <i className='trade-bracket-icon text-negative flip-horizontal icarus-terminal-signal' /></>
