  ...
  return (
    <header>
      ...
      <div className='header__navigation' style={{ display: 'block' }}>
        ...
        <button aria-label='Settings' className='button --no-hover is-hidden-mobile' onClick={showThemeSettings}>
        ...
        <div className='header__menu is-visible-mobile' style={{ visibility: menuVisible ? 'visible' : 'hidden' }}>
          ...
          <button aria-label='Settings' className='header__menu-item' onClick={showThemeSettings}>
            <i className='icon icarus-terminal-settings' />
            Settings
          </button>
